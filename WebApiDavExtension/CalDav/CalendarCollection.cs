...
{
	public abstract class CalendarCollection : CollectionResource 
	{
		...
		public virtual object CTag { get; set; }
		...
		public List<ReportType> SupportedReportSet { get; protected set; }
